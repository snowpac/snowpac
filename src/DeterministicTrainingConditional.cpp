...
void DeterministicTrainingConditional::estimate_hyper_parameters_all ( std::vector< std::vector<double> > const &nodes,
...
void DeterministicTrainingConditional::estimate_hyper_parameters_ls_only ( std::vector< std::vector<double> > const &nodes,
                                                  std::vector<double> const &values,
                                                  std::vector<double> const &noise )
{
