                                      ...
                                      std::vector<double> const &new_node ) 
{
  ...
  std::vector< int > safenodes = evaluations.active_index;
...
//  nb_nodes = tmp_int;
  ...
  if ( nb_nodes < dim + 1) {
    for ( int i = 0; i < safenodes.size(); ++i ) {
      std::cout << evaluations.nodes[safenodes[i]][0] << ", " << 
                   evaluations.nodes[safenodes[i]][1] << std::endl;
      std::cout << "...." << std::endl;
    }
      
  }

  assert( nb_nodes >= dim + 1);
...
//      new_node = q2;
  ...
  if ( evaluations.best_index == evaluations.active_index[change_index] ) {
    for (int i = 0; i < evaluations.active_index.size(); ++i)
      std::cout << evaluations.active_index[i] << std::endl;
    std::cout << "......." << std::endl;
    std::cout << evaluations.best_index << std::endl;
    std::cout << "......." << std::endl;
    std::cout << change_index << std::endl;
  }
